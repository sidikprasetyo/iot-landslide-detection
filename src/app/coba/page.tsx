...
const DailyPatternChart = () => {
  // Sample data
  const sampleData = [
    { time: "00:00", tilt: 5.2, rainfall: 0.0, moisture: 18.5 },
    { time: "04:00", tilt: 8.3, rainfall: 2.1, moisture: 22.7 },
    { time: "08:00", tilt: 15.7, rainfall: 5.8, moisture: 35.2 },
    { time: "12:00", tilt: 22.4, rainfall: 8.5, moisture: 42.8 },
    { time: "16:00", tilt: 18.9, rainfall: 4.3, moisture: 30.5 },
    { time: "20:00", tilt: 10.2, rainfall: 1.7, moisture: 25.3 }
  ];
        ...
        >
          ...
          <Tooltip
            ...
            formatter={(value, name) => {
              ...
              return [`${parseFloat(value).toFixed(1)} ${units[name] || ""}`, name];
            }}
          />
          <Legend />
          <Line
...
const HomePage = () => {
  ...
  const sensorData = {
    powerSource: "USB",
    battery: 80.1,     // percentage
    state: "Running",
    tilt: 14.1,        // degrees
    moisture: 23.3,    // percentage
    rainfall: 3.6     // mm/h
  };

  return (
    <div className="mx-9 mt-2 md:mx-[4.063rem] lg:mx-[5.313rem] md:mt-3">
      {/* First row of cards */}
